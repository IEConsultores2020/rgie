...
class CiudadsControllerTest < ActionController::TestCase
  ...
  test "should create ciudad" do
    assert_difference('Ciudad.count') do
      post :create, ciudad: { departamento_id: @ciudad.departamento_id, latitude: @ciudad.latitude, longitude: @ciudad.longitude, name: @ciudad.name, user_id: @ciudad.user_id }
    end
  ...
  test "should update ciudad" do
    patch :update, id: @ciudad, ciudad: { departamento_id: @ciudad.departamento_id, latitude: @ciudad.latitude, longitude: @ciudad.longitude, name: @ciudad.name, user_id: @ciudad.user_id }
    assert_redirected_to ciudad_path(assigns(:ciudad))
  end
